...
> = {
  "1": {
    ...
    ingredients:
      "Okro, fresh fish, palm oil, crayfish, stockfish, periwinkle, seasoning cubes, uziza leaves, pepper, salt",
  ...
  "2": {
    ...
    restaurant: "Eni Stores",
    ingredients:
      "Rice, tomatoes, red bell peppers, onions, scotch bonnet peppers, palm oil, curry powder, thyme, bay leaves, plantains, vegetable oil, salt",
  ...
  "3": {
    ...
    restaurant: "Eni Stores",
    ingredients:
      "Assorted meat (goat, beef, or fish), scotch bonnet peppers, uziza leaves, calabash nutmeg, alligator pepper, onions, garlic, ginger, stock cubes, salt",
  ...
  "4": {
    ...
    restaurant: "Eni Stores",
    ingredients:
      "Yam, spinach, tomatoes, red bell peppers, palm oil, meat (beef, goat, or fish), locust beans, stock cubes, salt, pepper",
  ...
  "5": {
    ...
    ingredients:
      "Flatbread, marinated chicken or beef, lettuce, tomatoes, onions, garlic sauce, mayonnaise, pickles, Coca-Cola",
  ...
  "6": {
    ...
    restaurant: "Kilimanjaro",
    ingredients:
      "Fresh fish fillet, potatoes, olive oil, herbs, lemon, tartar sauce, salt, pepper",
  ...
  "7": {
    ...
    ingredients:
      "Chicken pieces, flour, breadcrumbs, eggs, potatoes, vegetable oil, herbs, spices, special sauce, salt",
  ...
  "8": {
    ...
    restaurant: "Chicken Republic",
    ingredients:
      "Mixed salad greens, grilled chicken breast, cherry tomatoes, cucumbers, red onions, olive oil, balsamic vinegar, herbs, salt, pepper",
  ...
  "9": {
    ...
    ingredients:
      "Pizza dough, tomato sauce, mozzarella cheese, fresh basil, olive oil, salt, pepper",
  ...
  "10": {
    ...
    restaurant: "Pizza Palace",
    ingredients:
      "Pizza dough, tomato sauce, mozzarella cheese, pepperoni, olive oil, salt, pepper",
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.mealDetailsCard}>
        <View style={styles.mealDetailsInnerCard}>
          <View
            style={{
              width: 150,
              height: 100,
...
const styles = StyleSheet.create({
  ...
  mealDetailsInnerCard: {
    backgroundColor: Colors.myDefinedColors.white,
    padding: 10,
    borderRadius: 20,
    // alignItems: 'center'
  },
  mealDetailsInnerCardImage: {
    width: "100%",
  },
  quantityPriceRow: {
    marginTop: 10,
